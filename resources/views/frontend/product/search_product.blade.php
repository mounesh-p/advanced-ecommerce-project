{{-- <ul>
    ...
    <li><img src="{{ asset($item->product_thambnail) }}" alt="" width="30" height="30">
    {{ $item->product_name_en }}</li>
    @endforeach
</ul> --}}
    ...
    <div class="container mt-5">
        <div class="row d-flex justify-content-center ">
            <div class="col-md-6">
                ...
                @foreach($products as $item)
       <a href="{{ url('Product/detail/'.$item->id.'/'.$item->product_slug_en ) }}" target="_blank">
