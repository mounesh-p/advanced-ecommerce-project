    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
                            ...
                            <div class="item" style="background-image: url({{ asset($slider->slider_image) }});">
                                <div class="container-fluid">
                                    <div class="caption bg-color vertical-center text-left">
                                        ...
                                        <div class="excerpt fadeInDown-2 hidden-xs"> <span>{{ $slider->desc }}</span>
                                        </div>
                ...
                <!-- ==================== SKIP CATEGORY PRODUCTS 0 : PRODUCTS ====================== -->
                <section class="section featured-product wow fadeInUp">
                                ...
                                <div class="item">
                                    <div class="blog-post">
                                        <div class="blog-post-image">
                                            <div class="image"> <a href="{{ route('blog.detail', $blog->id) }}"><img
                                        ...
                                        <div class="blog-post-info text-left">
                                            <h3 class="name"><a href="{{ route('blog.detail', $blog->id) }}">
                                                    @if (session()->get('language') == 'hindi')
                                                        {{ $blog->post_title_hin }}
                                                    @else
                                                        {{ $blog->post_title_en }}
                                            ...
                                            <span
                                                class="info">{{ Carbon\Carbon::parse($blog->created_ad)->diffForHumans() }}
                                            </span>
                                            <p class="text">
                                                @if (session()->get('language') == 'hindi')
