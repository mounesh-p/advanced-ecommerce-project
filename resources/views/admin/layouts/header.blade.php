        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
			<a href="#" class="p-0 rounded waves-effect waves-light dropdown-toggle" data-toggle="dropdown" title="User">
				<img src="{{ (!empty(Auth::guard('admin')->user()->profile_photo_path)) ? url(Auth::guard('admin')->user()->profile_photo_path) : url('images/no_image.jpg') }}" alt="">
			</a>
			<ul class="dropdown-menu animated flipInX">
			  <li class="user-body">
				 <a class="dropdown-item" href="{{ route('admin.profile') }}"><i class="mr-2 ti-user text-muted"></i> Profile</a>
				 <a class="dropdown-item" href="{{ route('admin.changePassword') }}"><i class="mr-2 ti-wallet text-muted"></i> Change Password</a>
