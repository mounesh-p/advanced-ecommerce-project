                ...
                <div class="overflow-hidden box pull-up">
                    <div class="box-body">
                        ...
                        <div>
                            ...
                            <h3 class="mb-0 text-white font-weight-500">${{ $today  }} <small class="text-success"><i class="fa fa-caret-up"></i> Usd</small></h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="overflow-hidden box pull-up">
                    <div class="box-body">
                        ...
                        <div>
                            ...
                            <h3 class="mb-0 text-white font-weight-500">${{ $month  }} <small class="text-success"><i class="fa fa-caret-up"></i>Usd</small></h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="overflow-hidden box pull-up">
                    <div class="box-body">
                        ...
                        <div>
                            ...
                            <h3 class="mb-0 text-white font-weight-500">${{ $year }}  <small class="text-danger"><i class="fa fa-caret-down"></i> Usd</small></h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="overflow-hidden box pull-up">
                    <div class="box-body">
                        ...
                        <div>
                            ...
                            <h3 class="mb-0 text-white font-weight-500">{{ count($pending) }} <small class="text-danger"><i class="fa fa-caret-up"></i> Pending Order</small></h3>
                        </div>
                    </div>
                </div>
            </div>
